...
<script type="text/javascript" src="js/NodeTraversal.js"></script>
<script type="text/javascript" src="js/HeaderManipulation.js"></script>
<script type="text/javascript" src="js/NodeBuildAndDisplay.js"></script>
...
Waves.attach('.menu-item', ['waves-block']);
Waves.attach('#termsOfUseItem', ['waves-block', 'waves-light']);
Waves.attach('#privacyPolicyItem', ['waves-block']);
Waves.init();
</script>